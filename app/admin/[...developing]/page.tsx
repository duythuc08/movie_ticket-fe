...
export default function AdminDevelopingPage() {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[60vh] gap-4 text-center">
      ...
      <h1 className="text-3xl font-bold ">Đang phát triển</h1>
      <p className="text-gray-400 max-w-md">
        Tính năng này đang trong quá trình phát triển và sẽ sớm được ra mắt.
      </p>
      <Link
        href="/admin"
        className="mt-2 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-medium  hover:bg-indigo-500 transition-colors"
      >
        Quay về Dashboard
      </Link>
    </div>
